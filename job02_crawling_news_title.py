...
options.add_argument('user-agent=' + user_agent)    #브러우저가 아니면 안주기때문에 유저에이전트로 받음
...
for l in range(6):
    ...
    for k in range(1, 3): #pages[l]+1
        ...
        ## 'https://news.naver.com/main/main.naver?mode=LSD&mid=shm&sid1=10{}#&date=%2000:00:00&page={} 주소를 for문 별로 설정
        driver.get(url)
        time.sleep(0.5)
